...
try {
  ...
  >`
    SELECT current_projection.applied_count::integer AS "currentCount",
           ...
           app.release_runtime_schema_readiness_v56() AS "releaseReady",
           app.federated_authentication_schema_readiness_v56()
             AS "federationV56Ready",
