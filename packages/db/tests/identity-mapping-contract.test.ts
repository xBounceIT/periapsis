...
describe("tenant LDAP identity-mapping protected ABI", () => {
  ...
  it("preserves exact v9 readiness while runtime uses v58", () => {
    ...
    expect(apiHealth).toContain("from app.schema_compatibility_v58()");
    expect(workerHealth).toContain("from app.schema_compatibility_v58()");
