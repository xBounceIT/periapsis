...
describe("tenant LDAP identity-mapping protected ABI", () => {
  ...
  it("preserves exact v9 readiness while runtime uses v55", () => {
    ...
    expect(apiHealth).toContain("from app.schema_compatibility_v55()");
    expect(workerHealth).toContain("from app.schema_compatibility_v55()");
