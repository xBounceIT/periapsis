-- V58 seals the complete 0000-0247 migration and protected dependency surface.
...
CREATE FUNCTION app.private_schema_compatibility_journal_v58()
RETURNS TABLE(
...
REVOKE ALL ON FUNCTION app.private_schema_compatibility_journal_v58()
  FROM PUBLIC,periapsis_api,periapsis_worker,periapsis_notifier,
       periapsis_auditor;
--> statement-breakpoint

CREATE FUNCTION app.schema_compatibility_v58()
RETURNS TABLE(
...
BEGIN
  ...
  FROM app.private_schema_compatibility_journal_v58() AS journal;
  ...
  IF journal_count=248 AND journal_latest_created_at=1788818321637
...
END;
$function$;
ALTER FUNCTION app.schema_compatibility_v58() OWNER TO periapsis_migrator;
REVOKE ALL ON FUNCTION app.schema_compatibility_v58()
  FROM PUBLIC,periapsis_api,periapsis_worker,periapsis_notifier,
       periapsis_auditor;
GRANT EXECUTE ON FUNCTION app.schema_compatibility_v58()
...
CREATE FUNCTION app.private_release_runtime_dependency_surface_hash_v58()
...
self_excluded_function(function_oid) AS (
  VALUES
    (pg_catalog.to_regprocedure('app.schema_compatibility_v58()')),
    (pg_catalog.to_regprocedure('app.private_release_runtime_dependency_surface_hash_v58()')),
    (pg_catalog.to_regprocedure('app.private_release_runtime_schema_readiness_v58()')),
...
FROM catalog_entry;
$function$;
ALTER FUNCTION app.private_release_runtime_dependency_surface_hash_v58()
  OWNER TO periapsis_migrator;
...
CREATE FUNCTION app.private_release_runtime_schema_readiness_v58()
...
BEGIN
  IF current_setting('server_version_num')::integer<180000
     ...
     OR app.private_release_runtime_dependency_surface_hash_v58()<>
    '48764f1ad74d04086ea480dad0f8bfca836d45b65e7bfae64a4c316478afd11f' THEN
    RETURN false;
  END IF;
...
END;
$function$;
ALTER FUNCTION app.private_release_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
REVOKE ALL ON FUNCTION app.private_release_runtime_schema_readiness_v58()
  FROM PUBLIC,periapsis_api,periapsis_worker,periapsis_notifier,
       periapsis_auditor;
--> statement-breakpoint

CREATE FUNCTION app.release_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
DECLARE current_count bigint;
BEGIN
  SELECT compatibility.applied_count INTO current_count
  FROM app.schema_compatibility_v58() AS compatibility;
  RETURN current_count=248
    AND app.private_release_runtime_schema_readiness_v58()
    AND (
      ...
      SELECT count(*)=14 AND coalesce(bool_and(
...
END;
$function$;
ALTER FUNCTION app.release_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
REVOKE ALL ON FUNCTION app.release_runtime_schema_readiness_v58()
  FROM PUBLIC,periapsis_api,periapsis_worker,periapsis_notifier,
       periapsis_auditor;
GRANT EXECUTE ON FUNCTION app.release_runtime_schema_readiness_v58()
  TO periapsis_api,periapsis_worker,
     periapsis_notification_readiness_owner;
--> statement-breakpoint

-- Feature-specific production probes all require the sealed V58 release root.
...
CREATE FUNCTION app.federated_authentication_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58();
EXCEPTION WHEN undefined_table OR undefined_function OR insufficient_privilege
  OR invalid_schema_name OR cardinality_violation OR data_exception THEN
  RETURN false;
END;
$function$;
CREATE FUNCTION app.platform_oidc_direct_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58();
EXCEPTION WHEN undefined_table OR undefined_function OR insufficient_privilege
...
END;
$function$;
CREATE FUNCTION app.platform_saml_direct_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58();
EXCEPTION WHEN undefined_table OR undefined_function OR insufficient_privilege
...
END;
$function$;
CREATE FUNCTION app.platform_local_account_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
END;
$function$;
CREATE FUNCTION app.sla_trigger_action_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
END;
$function$;
CREATE FUNCTION app.sla_object_event_ingress_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
END;
$function$;
CREATE FUNCTION app.ticket_bulk_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
END;
$function$;
CREATE FUNCTION app.ticket_export_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
END;
$function$;
CREATE FUNCTION app.ticket_metadata_runtime_schema_readiness_v58()
RETURNS boolean LANGUAGE plpgsql STABLE SECURITY DEFINER
SET search_path=pg_catalog,public,app AS $function$
BEGIN RETURN app.release_runtime_schema_readiness_v58()
...
CREATE FUNCTION app.notification_dispatch_readiness_v58()
RETURNS TABLE(
  queue_depth bigint,
  role_safe boolean,
  schema_safe boolean,
...
BEGIN
  ...
  schema_safe := app.release_runtime_schema_readiness_v58();
  RETURN NEXT;
EXCEPTION WHEN undefined_table OR undefined_function OR insufficient_privilege
  OR invalid_schema_name OR cardinality_violation OR data_exception THEN
  queue_depth := 0;
...
ALTER FUNCTION app.federated_authentication_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.platform_oidc_direct_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.platform_saml_direct_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.platform_local_account_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.sla_trigger_action_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.sla_object_event_ingress_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.ticket_bulk_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.ticket_export_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.ticket_metadata_runtime_schema_readiness_v58()
  OWNER TO periapsis_migrator;
ALTER FUNCTION app.notification_dispatch_readiness_v58()
...
CREATE FUNCTION app.private_rotate_notification_readiness_v58()
...
END;
$function$;
ALTER FUNCTION app.private_rotate_notification_readiness_v58()
  OWNER TO periapsis_notification_readiness_owner;
REVOKE ALL ON FUNCTION app.private_rotate_notification_readiness_v58()
  FROM PUBLIC,periapsis_api,periapsis_worker,periapsis_notifier,
       periapsis_auditor,periapsis_notification_admin_owner,
       periapsis_notification_dispatch_owner;
GRANT EXECUTE ON FUNCTION app.private_rotate_notification_readiness_v58()
...
DECLARE
  ...
  was_sealed boolean;
BEGIN
  IF p_expected_count IS DISTINCT FROM 248
     OR p_expected_latest_created_at IS DISTINCT FROM 1788818321637
     OR p_expected_latest_hash !~ '^[0-9a-f]{64}$'
     OR p_expected_migration_fingerprint !~
       '^[0-9]+@[0-9a-f]{64}(:[0-9]+@[0-9a-f]{64}){247}$' THEN
    RAISE EXCEPTION 'schema compatibility v58 seal input is invalid'
      USING ERRCODE='55000';
  END IF;
  ...
  IF ROW(journal_count,journal_latest_created_at,journal_latest_hash,
     ...
     OR NOT app.private_release_runtime_schema_readiness_v58() THEN
    RAISE EXCEPTION 'schema compatibility v58 pre-seal verification failed'
      USING ERRCODE='55000';
  END IF;

  SELECT coalesce((
    SELECT compatibility.applied_count=248
    FROM app.schema_compatibility_v58() AS compatibility
  ),false) INTO was_sealed;

  IF NOT was_sealed THEN
    EXECUTE pg_catalog.format(
      'ALTER FUNCTION app.schema_compatibility_v58() SET app.schema_compatibility_fingerprint = %L',
      p_expected_migration_fingerprint
    );
    ...
    PERFORM app.private_rotate_notification_readiness_v58();
  ...
  IF NOT was_sealed THEN
    IF sealed_count<>248
       OR NOT app.private_release_runtime_schema_readiness_v58() THEN
      RAISE EXCEPTION 'schema compatibility v58 rotation verification failed'
        USING ERRCODE='55000';
    END IF;
    RETURN;
  END IF;
  IF sealed_count<>248
     OR NOT app.private_release_runtime_schema_readiness_v58()
     OR NOT app.release_runtime_schema_readiness_v58()
     OR NOT app.federated_authentication_schema_readiness_v58()
     OR NOT app.platform_oidc_direct_runtime_schema_readiness_v58()
     OR NOT app.platform_saml_direct_runtime_schema_readiness_v58()
     OR NOT app.platform_local_account_runtime_schema_readiness_v58()
     OR NOT app.sla_trigger_action_runtime_schema_readiness_v58()
     OR NOT app.sla_object_event_ingress_schema_readiness_v58()
     OR NOT app.ticket_bulk_runtime_schema_readiness_v58()
     OR NOT app.ticket_export_runtime_schema_readiness_v58()
     OR NOT app.ticket_metadata_runtime_schema_readiness_v58()
     OR NOT (SELECT readiness.schema_safe
             FROM app.notification_dispatch_readiness_v58() AS readiness) THEN
    RAISE EXCEPTION 'schema compatibility v58 post-seal verification failed'
      USING ERRCODE='55000';
  END IF;
END;
$function$;
