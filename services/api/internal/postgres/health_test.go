...
func TestSchemaCompatibilityQuerySealsV61TrustedSet(t *testing.T) {
	if len(expectedTrustedFunctionSourceHashes) != 27 {
		t.Fatalf("trusted source hash count = %d, want 27", len(expectedTrustedFunctionSourceHashes))
	}
	...
	if expectedTrustedFunctionSourceHashes[17] != expectedAPIRuntimeReadinessV61SourceHash {
	...
	roots := []struct {
		...
		{"app.api_runtime_schema_readiness_v61()", 2},
		...
		{"app.federated_authentication_schema_readiness_v61()", 1},
		{"app.platform_oidc_direct_runtime_schema_readiness_v61()", 1},
		{"app.platform_saml_direct_runtime_schema_readiness_v61()", 1},
		{"app.platform_local_account_runtime_schema_readiness_v61()", 1},
		{"app.ticket_bulk_runtime_schema_readiness_v61()", 1},
		{"app.ticket_export_runtime_schema_readiness_v61()", 1},
		{"app.ticket_metadata_runtime_schema_readiness_v61()", 1},
