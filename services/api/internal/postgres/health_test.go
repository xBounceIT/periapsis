...
func TestSchemaCompatibilityQuerySealsV50TrustedSet(t *testing.T) {
	...
	roots := []struct {
		...
		{"app.federated_authentication_schema_readiness_v50()", 2},
		{"app.platform_oidc_direct_runtime_schema_readiness_v50()", 2},
		{"app.platform_saml_direct_runtime_schema_readiness_v50()", 2},
		{"app.platform_local_account_runtime_schema_readiness_v50()", 2},
		{"app.ticket_bulk_runtime_schema_readiness_v50()", 2},
		{"app.ticket_export_runtime_schema_readiness_v50()", 2},
		{"app.ticket_metadata_runtime_schema_readiness_v50()", 2},
