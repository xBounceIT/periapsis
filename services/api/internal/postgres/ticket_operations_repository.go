...
const (
	...
	ticketBulkReadinessABIQuery   = `SELECT app.ticket_bulk_runtime_schema_readiness_v54()`
	ticketExportReadinessABIQuery = `SELECT app.ticket_export_runtime_schema_readiness_v54()`
	ticketMetadataReadinessQuery  = `SELECT app.ticket_metadata_runtime_schema_readiness_v54()`
)
