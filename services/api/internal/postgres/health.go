...
with expected_trusted_function(
  ...
  values
    (1, 'compatibility', 'app.schema_compatibility_v61()', 'plpgsql', array[
    ...
    (4, 'journal', 'app.private_schema_compatibility_journal_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
    ...
    (6, 'private_release',
     ...
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedOwnerACL + `),
    (7, 'release', 'app.release_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedReleaseACL + `),
    (8, 'federated', 'app.federated_authentication_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (9, 'oidc', 'app.platform_oidc_direct_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (10, 'saml', 'app.platform_saml_direct_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (11, 'local_account',
     ...
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (12, 'ticket_bulk', 'app.ticket_bulk_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedRuntimeACL + `),
    (13, 'ticket_export', 'app.ticket_export_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedRuntimeACL + `),
    (14, 'ticket_metadata',
    ...
    (17, 'retired_v51', 'app.schema_compatibility_v51()', 'plpgsql', array[
     ...
     'TABLE(applied_count bigint, latest_created_at bigint, latest_hash text, migration_fingerprint text)',
     ` + trustedOwnerACL + `),
    (18, 'api_aggregate', 'app.api_runtime_schema_readiness_v61()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean[]', ` + trustedAPIACL + `),
    ...
    (26, 'retired_v59', 'app.schema_compatibility_v59()', 'plpgsql', array[
     ...
     'TABLE(applied_count bigint, latest_created_at bigint, latest_hash text, migration_fingerprint text)',
     ` + trustedOwnerACL + `),
    (27, 'retired_v60', 'app.schema_compatibility_v60()', 'plpgsql', array[
       'search_path=pg_catalog',
       'app.schema_compatibility_fingerprint=RETIRED'
     ]::text[],
     'TABLE(applied_count bigint, latest_created_at bigint, latest_hash text, migration_fingerprint text)',
...
select applied_count, latest_created_at, latest_hash, migration_fingerprint,
       app.api_runtime_schema_readiness_v61() AS array,
...
var expectedTrustedFunctionSourceHashes = [...]string{
	...
	expectedFederatedAuthenticationReadinessV61SourceHash,
	expectedPlatformOIDCDirectRuntimeReadinessV61SourceHash,
	expectedPlatformSAMLDirectRuntimeReadinessV61SourceHash,
	expectedPlatformLocalAccountRuntimeReadinessV61SourceHash,
	expectedTicketBulkRuntimeReadinessV61SourceHash,
	expectedTicketExportRuntimeReadinessV61SourceHash,
	expectedTicketMetadataRuntimeReadinessV61SourceHash,
	...
	expectedAPIRuntimeReadinessV61SourceHash,
...
// CheckWithContext shares the fully attested V61 projection only with repository
