...
with expected_trusted_function(
  ...
  values
    ...
    (8, 'federated', 'app.federated_authentication_schema_readiness_v49()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (9, 'oidc', 'app.platform_oidc_direct_runtime_schema_readiness_v49()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (10, 'saml', 'app.platform_saml_direct_runtime_schema_readiness_v49()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (11, 'local_account',
     ...
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedAPIACL + `),
    (12, 'ticket_bulk', 'app.ticket_bulk_runtime_schema_readiness_v49()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedRuntimeACL + `),
    (13, 'ticket_export', 'app.ticket_export_runtime_schema_readiness_v49()',
     'plpgsql', array['search_path=pg_catalog, public, app']::text[],
     'boolean', ` + trustedRuntimeACL + `),
    (14, 'ticket_metadata',
...
var expectedTrustedFunctionSourceHashes = [...]string{
	...
	expectedFederatedAuthenticationReadinessV49SourceHash,
	expectedPlatformOIDCDirectRuntimeReadinessV49SourceHash,
	expectedPlatformSAMLDirectRuntimeReadinessV49SourceHash,
	expectedPlatformLocalAccountRuntimeReadinessV49SourceHash,
	expectedTicketBulkRuntimeReadinessV49SourceHash,
	expectedTicketExportRuntimeReadinessV49SourceHash,
	expectedTicketMetadataRuntimeReadinessV49SourceHash,
