    ...
    SmtpHealthConfigurationRepository
{
  ...
  async readiness(
    ...
    try {
          ...
          WITH expected(
            ...
            VALUES
              (
                ...
                ${expectedSchemaCompatibilityV49SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeDependencySurfaceHashV49SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeReadinessV49SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
              ...
              (
                ...
                ${expectedReleaseRuntimeReadinessV49SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
                ARRAY['search_path=pg_catalog, public, app']::text[],
                'boolean', ARRAY[
              ...
              (
                'app.notification_dispatch_readiness_v49()',
                ${expectedNotificationDispatchReadinessV49SourceHash}::text,
      ...
      // Once the V49 root has been observed, an undefined dependency is
