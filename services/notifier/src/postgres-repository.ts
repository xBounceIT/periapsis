    ...
    SmtpHealthConfigurationRepository
{
  ...
  async readiness(
    ...
    try {
          ...
          WITH expected(
            ...
            VALUES
              (
                ...
                ${expectedSchemaCompatibilityV55SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeDependencySurfaceHashV55SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeReadinessV55SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
              ...
              (
                ...
                ${expectedReleaseRuntimeReadinessV55SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
                ARRAY['search_path=pg_catalog, public, app']::text[],
                'boolean', ARRAY[
              ...
              (
                'app.notification_dispatch_readiness_v55()',
                ${expectedNotificationDispatchReadinessV55SourceHash}::text,
      ...
      // Once the V55 root has been observed, an undefined dependency is
