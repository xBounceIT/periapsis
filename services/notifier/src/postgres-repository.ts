    ...
    SmtpHealthConfigurationRepository
{
  ...
  async readiness(
    ...
    try {
          ...
          WITH expected(
            ...
            VALUES
              (
                ...
                ${expectedSchemaCompatibilityV57SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeDependencySurfaceHashV57SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeReadinessV57SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
              ...
              (
                ...
                ${expectedReleaseRuntimeReadinessV57SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
                ARRAY['search_path=pg_catalog, public, app']::text[],
                'boolean', ARRAY[
              ...
              (
                'app.notification_dispatch_readiness_v57()',
                ${expectedNotificationDispatchReadinessV57SourceHash}::text,
      ...
      // Once the V57 root has been observed, an undefined dependency is
