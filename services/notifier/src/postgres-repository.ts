    ...
    SmtpHealthConfigurationRepository
{
  ...
  async readiness(
    ...
    try {
          ...
          WITH expected(
            ...
            VALUES
              (
                ...
                ${expectedSchemaCompatibilityV62SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeDependencySurfaceHashV62SourceHash}::text,
              ...
              (
                ...
                ${expectedPrivateReleaseRuntimeReadinessV62SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
              ...
              (
                ...
                ${expectedReleaseRuntimeReadinessV62SourceHash}::text,
                'periapsis_migrator', 'plpgsql',
                ARRAY['search_path=pg_catalog, public, app']::text[],
                'boolean', ARRAY[
              ...
              (
                'app.notification_dispatch_readiness_v62()',
                ${expectedNotificationDispatchReadinessV62SourceHash}::text,
      ...
      // Once the V62 root has been observed, an undefined dependency is
