...
const (
	...
	ticketBulkReadinessQuery           = `SELECT app.ticket_bulk_runtime_schema_readiness_v49()`
	ticketExportReadinessQuery         = `SELECT app.ticket_export_runtime_schema_readiness_v49()`
)
