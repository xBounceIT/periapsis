...
func TestSchemaCompatibilityQuerySealsV56TrustedSet(t *testing.T) {
	...
	if expectedTrustedFunctionSourceHashes[14] != expectedWorkerRuntimeReadinessV56SourceHash {
	...
	roots := []struct {
		...
		{"app.worker_runtime_schema_readiness_v56()", 2},
		...
		{"app.sla_trigger_action_runtime_schema_readiness_v56()", 1},
		{"app.sla_object_event_ingress_schema_readiness_v56()", 1},
