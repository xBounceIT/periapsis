...
func TestSchemaCompatibilityQuerySealsV57TrustedSet(t *testing.T) {
	...
	if expectedTrustedFunctionSourceHashes[14] != expectedWorkerRuntimeReadinessV57SourceHash {
	...
	for _, required := range []string{
		...
		"(15, 'worker_aggregate', 'app.worker_runtime_schema_readiness_v57()'",
		"app.worker_runtime_schema_readiness_v57() AS array",
	...
	roots := []struct {
		...
		{"app.worker_runtime_schema_readiness_v57()", 2},
		...
		{"app.sla_trigger_action_runtime_schema_readiness_v57()", 1},
		{"app.sla_object_event_ingress_schema_readiness_v57()", 1},
