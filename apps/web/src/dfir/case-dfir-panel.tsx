...
export function CaseDfirPanel({
  api,
  caseId,
  csrfToken,
  hasPermission,
  tenantId,
}: CaseDfirPanelProps): React.JSX.Element {
  ...
  const canCreatePanel = (panel: DfirPanel): boolean =>
  ...
  }, [caseId, canReadWorkspace, hasPermission, queryClient, tenantId]);
