                    ...
                    <div>
                      ...
                      {attempt.providerReceipt ? (
                        <code>
                          Receipt{" "}
                          {compactNotificationId(
                            attempt.providerReceipt.receiptDigest,
                          )}
                        </code>
                      ) : null}
                    </div>
              ...
              <section className="notification-toolbox">
                ...
                {requiresSubmissionUncertainConfirmation(detail) ? (
                  <label className="notification-uncertain-confirm">
                    ...
                    />
                    <span>
                      <strong>Provider submission is uncertain</strong>I
                      understand the provider may already have accepted this
                      submission.
                    </span>
                  </label>
                ) : null}
