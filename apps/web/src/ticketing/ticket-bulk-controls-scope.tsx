...
function useTicketBulkControlsState({
  availableActions,
  csrfToken,
  kind,
  onClearSelection,
  ...
  const reviewOpen = reviewedRequest !== undefined;
  {
    if (
      ...
      action !== (availableActions[0] ?? "release")
    ) {
...
function createTicketBulkControlsActions({
  availableActions,
  csrfToken,
  kind,
  onClearSelection,
  ...
  retentionSeconds,
  query,
}: ReturnType<typeof useTicketBulkControlsState>) {
  ...
  return { review, buildRequestBody, submit, cancel, publishJob };
}

export function TicketBulkControlsScope(
  props: TicketBulkControlsProps,
): React.JSX.Element {
  const state = useTicketBulkControlsState(props);
  const {
    availableActions,
    csrfToken,
    kind,
  ...
  const { review, submit, cancel } = createTicketBulkControlsActions(state);
  return (
    <section
...
interface TicketBulkRequestFormProps {
  action: ReturnType<typeof useTicketBulkControlsState>["action"];
  assigneeId: ReturnType<typeof useTicketBulkControlsState>["assigneeId"];
  availableActions: ReturnType<
    typeof useTicketBulkControlsState
  >["availableActions"];
  csrfToken: ReturnType<typeof useTicketBulkControlsState>["csrfToken"];
  pending: ReturnType<typeof useTicketBulkControlsState>["pending"];
  retentionSeconds: ReturnType<
    typeof useTicketBulkControlsState
  >["retentionSeconds"];
  review: ReturnType<typeof createTicketBulkControlsActions>["review"];
  selectedTargets: ReturnType<
    typeof useTicketBulkControlsState
  >["selectedTargets"];
  selectionMode: ReturnType<typeof useTicketBulkControlsState>["selectionMode"];
  setAction: ReturnType<typeof useTicketBulkControlsState>["setAction"];
  setAssigneeId: ReturnType<typeof useTicketBulkControlsState>["setAssigneeId"];
  setRetentionSeconds: ReturnType<
    typeof useTicketBulkControlsState
  >["setRetentionSeconds"];
  setSelectionMode: ReturnType<
    typeof useTicketBulkControlsState
  >["setSelectionMode"];
  setTeamId: ReturnType<typeof useTicketBulkControlsState>["setTeamId"];
  setTo: ReturnType<typeof useTicketBulkControlsState>["setTo"];
  setTransition: ReturnType<typeof useTicketBulkControlsState>["setTransition"];
  teamId: ReturnType<typeof useTicketBulkControlsState>["teamId"];
  to: ReturnType<typeof useTicketBulkControlsState>["to"];
  transition: ReturnType<typeof useTicketBulkControlsState>["transition"];
}

function TicketBulkRequestForm({
  action,
  assigneeId,
  availableActions,
  csrfToken,
  ...
  to,
  transition,
}: TicketBulkRequestFormProps): React.JSX.Element {
  return (
    <form className="ticket-bulk-form" onSubmit={review}>
      ...
      <label>
        ...
        <select
          ...
          onChange={(event) => setRetentionSeconds(Number(event.target.value))}
        >
...
interface TicketBulkReviewDialogProps {
  action: ReturnType<typeof useTicketBulkControlsState>["action"];
  kind: ReturnType<typeof useTicketBulkControlsState>["kind"];
  pending: ReturnType<typeof useTicketBulkControlsState>["pending"];
  reviewedRequest: ReturnType<
    typeof useTicketBulkControlsState
  >["reviewedRequest"];
  reviewOpen: ReturnType<typeof useTicketBulkControlsState>["reviewOpen"];
  setReviewedRequest: ReturnType<
    typeof useTicketBulkControlsState
  >["setReviewedRequest"];
  submit: ReturnType<typeof createTicketBulkControlsActions>["submit"];
}

function TicketBulkReviewDialog({
  action,
  kind,
  pending,
  reviewedRequest,
  ...
  setReviewedRequest,
  submit,
}: TicketBulkReviewDialogProps): React.JSX.Element {
  return (
    <Dialog
      open={reviewOpen}
      onOpenChange={(open) => {
      ...
      <DialogContent>
        ...
        <div className="ticket-bulk-review">
          ...
          <p>
            ...
            broadens this receipt. Per-target authority is checked again by the
            worker.
          </p>
        </div>
        <DialogFooter>
